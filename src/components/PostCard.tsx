    ...
    >
      ...
      >
        ...
        <div className="absolute top-3 left-3">
          <span className="text-[10px] font-bold px-2 py-1 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md rounded-md uppercase tracking-wider text-slate-800 dark:text-slate-200 shadow-sm border border-slate-200/50 dark:border-slate-700/30">
            {post.category}
          </span>
        </div>
        ...
        <div className="border-t border-slate-100 dark:border-slate-800/80 pt-4 mt-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-800 flex items-center justify-center font-bold text-[10px] text-slate-600 dark:text-slate-300">
                ...
                <div className="flex items-center gap-1 border-l border-slate-200 dark:border-slate-800 pl-2 ml-1">
                  {onEdit && (
                    <button
                      ...
                      className="p-1 text-slate-400 dark:text-slate-500 hover:text-emerald-600 dark:hover:text-emerald-400 rounded hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
                      title="Edit Post"
                  ...
                  {onDelete && (
                    <button
                      ...
                      className="p-1 text-slate-400 dark:text-slate-500 hover:text-rose-600 dark:hover:text-rose-400 rounded hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
                      title="Delete Post"
